...
//           document.querySelector('#table').innerHTML += '<img src ="/public/images/mashPotatoes.jpg" alt = "match potatoes"/>'
...
async function makeFood(steps, id) {
  ...
  // document.querySelector('#table').innerHTML += '<img src ="/public/images/brusselSprouts.jpg" alt = "brussels sprout"/>'
  addImage(id.slice(1));
}
